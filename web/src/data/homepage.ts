...
export const homepageTeam: HomepageTeamMember[] = [
  {
    ...
    name: "Product Design",
    role: "UI/UX practice",
    specialty: "SaaS onboarding, dashboard systems, design tokens",
  },
  {
    initials: "FE",
    name: "Frontend Engineering",
    role: "Web practice",
    specialty: "React, Next.js, Tailwind, accessible UI",
  },
  {
    initials: "BE",
    name: "Backend Engineering",
    role: "Integrations practice",
    specialty: "Node, APIs, QuickBooks & Xero sync",
  },
  {
    initials: "UX",
    name: "UX Strategy",
    role: "Research practice",
    specialty: "User research, onboarding flows, conversion",
  },
  {
    initials: "DL",
    name: "Delivery Lead",
    role: "Project management",
    specialty: "Sprint planning, client communication, QA",
  },
];

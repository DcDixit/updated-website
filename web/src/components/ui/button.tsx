...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center bg-clip-padding font-semibold whitespace-nowrap transition-[opacity,background-color,border-color,color,transform] outline-none select-none focus-visible:border-[var(--color-accent)] focus-visible:ring-[3px] focus-visible:ring-[var(--focus-ring-color)] active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        primary:
          "btn-accent-glow border border-transparent bg-[var(--color-accent)] text-white hover:opacity-95 dark:text-black",
        secondary:
      ...
      size: {
        ...
        cta: "h-12 min-h-12 gap-2 rounded-xl px-7 text-base [&_svg:not([class*='size-'])]:size-5",

...
const serviceTagMap: Record<ServiceSlug, readonly string[]> = {
  ...
  "ux-research": ["UI/UX", "Product", "SaaS"],
  "wireframing-prototyping": ["UI/UX", "Product", "SaaS"],
  "design-systems": ["Product", "SaaS", "UX"],
  "web-application-design": ["Web", "SaaS", "Product"],
  "dashboard-design": ["Dashboard", "SaaS", "CRM"],
  "logo-design": ["Branding", "Web", "E-commerce"],

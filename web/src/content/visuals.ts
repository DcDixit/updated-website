...
export const serviceVisuals: Record<ServiceSlug, VisualAsset> = {
  ...
  "ux-research": { src: img.tech.design, alt: "UX research session with user interview insights" },
  "wireframing-prototyping": { src: img.tech.design, alt: "Wireframes and interactive product prototypes" },
  "design-systems": { src: img.tech.design, alt: "Design system components and token library" },
  "web-application-design": { src: img.tech.frontend, alt: "Web application interface design on desktop" },
  "dashboard-design": { src: img.sections.saas, alt: "Analytics dashboard design with KPI widgets" },
  "logo-design": { src: img.tech.branding, alt: "Logo design concepts and brand mark exploration" },
